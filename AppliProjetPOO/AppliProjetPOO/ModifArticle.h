...
namespace AppliProjetPOO {
	...
	/// <summary>
	/// Description résumée de ModifArticle
	/// </summary>
	public ref class ModifArticle : public System::Windows::Forms::Form
	{
	public: Connect^ conn;
	public:
		ModifArticle(void)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnValider->Location = System::Drawing::Point(52, 610);
			...
			this->btnValider->Click += gcnew System::EventHandler(this, &ModifArticle::btnValider_Click);
			// 
			// textBoxCouleur
			// 
			this->textBoxCouleur->Location = System::Drawing::Point(402, 514);
			...
			this->textBoxCouleur->TabIndex = 30;
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(44, 514);
			...
			// textBoxNature
			// 
			this->textBoxNature->Location = System::Drawing::Point(402, 450);
			...
			this->textBoxNature->TabIndex = 28;
			// 
			// label7
			// 
			...
			this->label7->Location = System::Drawing::Point(47, 450);
			...
			this->label8->Location = System::Drawing::Point(44, 383);
			...
			this->label5->Size = System::Drawing::Size(456, 44);
			this->label5->TabIndex = 24;
			this->label5->Text = L"Modofication de l\'article";
			// 
			// textBoxSeuilAppro
			// 
			this->textBoxSeuilAppro->Location = System::Drawing::Point(402, 322);
			...
			this->textBoxSeuilAppro->TabIndex = 23;
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(44, 322);
			...
			// textBoxPrix
			// 
			this->textBoxPrix->Location = System::Drawing::Point(402, 258);
			...
			this->label4->Location = System::Drawing::Point(44, 258);
			...
			// textBoxStock
			// 
			this->textBoxStock->Location = System::Drawing::Point(402, 191);
			...
			this->label2->Location = System::Drawing::Point(44, 191);
			...
			// textBoxNom
			// 
			this->textBoxNom->Location = System::Drawing::Point(402, 127);
			...
			this->label1->Location = System::Drawing::Point(44, 127);
			...
			this->Name = L"ModifArticle";
			this->Text = L"ModifArticle";
